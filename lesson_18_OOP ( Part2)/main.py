"""self yra skirtas kereipimasis. Penki vienodi namai tik skirtingas adresas"""
"""__init__ - inicealizuoja sukuriant objekta"""
# Access modifiers - 
# public - galimas naudoti is kazkur kitur
# _surname jis gali buti naudojamas tik klases viduje(su _underscoure))(protected) naudojami tik klases viduje ir child klases
# self.__age = age private(gausime atribute error) tik klases visuje.
# instant metodas(funkcija) 
# inherinti tai kreipris i childa
"""
...
#         self.smth = None#     def get_car_color(self) -> None:
