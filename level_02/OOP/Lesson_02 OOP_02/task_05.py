"""
Nasa needs to calculate expenses for the new mission: 
using OOP principles implement Base and Space Shuttle classes. Create a simple calculator with:
...
import timeimport loggingimport logging.configlogging.config.fileConfig(fname="logging.conf", disable_existing_loggers=False)
...
class SpaceShuttle(Carrier):
    def __init__(self, cost: float, year_built: int, weight: float) -> None:
        ...
        CEPAJAV_CONSTANT = 2500    """Imperial units everywhere"""    
